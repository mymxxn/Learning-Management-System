...
class ConstantImages {
  ...
  static const String logo = '${base}logo.jpeg';
  static const String splashScreen = '${base}splashscreenLogo.png';
  static const String loginScreenImage = '${base}login_screen_image.png';
}
